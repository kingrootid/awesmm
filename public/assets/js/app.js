!(function () {
    ...
    var s = localStorage.getItem("language"),
        n = "en";
    function o(a) {
        var t = document.getElementsByClassName("header-lang-img");
    ...
    function r() {
        ...
        e.hasAttribute("data-layout") &&
        "horizontal" == e.getAttribute("data-layout")
            ? (i(
              ...
              (document.getElementsByClassName("footer")[0].style.display =
                  "block"),
              "light" == e.hasAttribute("data-topbar")
                  ? (i("topbar-color-light"),
                    document.body.setAttribute("data-topbar", "light"))
                  : "dark" == e.hasAttribute("data-topbar") &&
                    (i("topbar-color-dark"),
    ...
    for (
        ...
        b[(d = y)] &&
            b[d].addEventListener("click", function (t) {
                t.preventDefault(),
            ...
            t &&
                t.forEach(function (t) {
                    ...
                    t.href == e &&
                        ...
                        t.classList.contains("mm-collapsing") &&
    ...
    [].slice
        ...
        (c = document.body),
        (u = document.getElementsByClassName("right-bar-toggle")),
        ...
        (c = document.getElementsByTagName("body")[0]).hasAttribute(
            ...
            ? (i("layout-horizontal"),
              "light" == c.hasAttribute("data-topbar")
                  ? (i("topbar-color-light"),
                    document.body.setAttribute("data-topbar", "light"))
                  : "dark" == c.hasAttribute("data-topbar") &&
                    (i("topbar-color-dark"),
                    document.body.setAttribute("data-topbar", "dark")),
