            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form id="login" method="POST">
                                        ...
                                        <div class="mt-4">
                                            <button class="btn btn-success w-100" type="submit" id="btn_login">Login</button>
                                        </div>

                                        <div class="mt-4 text-center">
                                            <div class="signin-other-title">
                                                <h5 class="fs-13 mb-4 title">Login Dengan Social Media</h5>
                                            </div>
                                            <div>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Belum punya akun ? <a href="{{ url('auth/register') }}" class="fw-semibold text-primary text-decoration-underline"> Register </a> </p>
                        </div>
