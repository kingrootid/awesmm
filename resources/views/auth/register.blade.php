...
<body>
            ...
            <div class="container">
                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index.html" class="d-inline-block auth-logo">
                                    <img src="{{ asset('/') }}{{ get_config('logo') }}" style="height:4rem">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form id="login" method="POST">
                                        ...
                                        <div class="mb-3">
                                            <div class="float-end">
                                                <a href="{{ url('auth/forgot') }}" class="text-muted">Lupa Password?</a>
                                            </div>
                                        ...
                                        <div class="mt-4">
                                            <button class="btn btn-success w-100" type="submit" id="btn_register">Register</button>
                                        </div>

                                        <div class="mt-4 text-center">
                                            <div class="signin-other-title">
                                                <h5 class="fs-13 mb-4 title">Daftar Dengan Social Media</h5>
                                            </div>
                                            <div>
                                                <a href="{{ url('auth/provider/google') }}" class="btn btn-danger btn-icon waves-effect waves-light"><i class="ri-google-fill fs-16"></i></a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Sudah Punya Akun ? <a href="{{ url('auth/login') }}" class="fw-semibold text-primary text-decoration-underline"> Login </a> </p>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                ...
                                </script> {{ get_config('site_name') }}. Dibuat dengan <i class="mdi mdi-heart text-danger"></i> by RootWritter
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $("#login").submit(function(e) {
            ...
            $("#btn_register").html(`<i class="fas fa-spinner fa-spin"></i> Mohon tunggu...`)
